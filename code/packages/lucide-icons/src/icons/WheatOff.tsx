...
export const WheatOff: IconComponent = themed(
  memo(function WheatOff(props: IconProps) {
    ...
    return (
      ...
      >
        ...
        <Path d="m16 8-1.17 1.17" stroke={color} />
        <Path
        ...
        <Path
          ...
          stroke={color}
        />
        <Path d="M20 2h2v2a4 4 0 0 1-4 4h-2V6a4 4 0 0 1 4-4Z" stroke={color} />
        <Path
